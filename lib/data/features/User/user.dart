...
import 'package:pfe/data/features/User/FileCoverter.dart';
...
Future<Autogenerated> login(String phone, String password) async {
  final response = await http.post(
    Uri.parse(VPNURL + 'user/login'),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=UTF-8',
    },
...
Future<User> otp(String phone, String code) async {
  final response = await http.patch(
    Uri.parse(VPNURL + 'user/activateAccount'),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=UTF-8',
    },
    body:
...
Future<User> getanimal(String id) async {
  ...
  var Response = await http.get(Uri.parse(VPNURL + 'user/getUser/$id'));
  final String responseString = Response.body;
...
Future<dynamic> getmes(String id) async {
  ...
  var Response = await http.get(Uri.parse(
      VPNURL+  'annonce/getmesannonce/$id'));
  final String responseString = Response.body;
...
Future<dynamic> getuser() async {
  ...
  var Response = await http.get(
      Uri.parse(VPNURL+'user/getUsers'));
  final String responseString = Response.body;
...
Future getOneAnimal(iduser, idanimal) async {
  ...
  var request = http.Request('GET',
      Uri.parse(VPNURL+'/user/getAnimal'));
...
Future<dynamic> addanimal(user, name, genre, date_naissence, etat_sante, poids,
    race, taille, type, image ,description) async {
   String urlimage = "http://51.75.87.48:14600/user/addanim";
  var request =
  http.MultipartRequest('POST', Uri.parse(urlimage));
  request.fields["id"]=user;
  request.fields["name"]=name;
  request.fields["genre"]=genre;
  request.fields["date_naissance"]=date_naissence;



   request.fields["etat_sante"]=etat_sante;
   request.fields["poids"]=poids;
   request.fields["taille"]=taille;
   request.fields["race"]=race;
   request.fields["type_animal"]=type;
...
// String urlimage = "http://51.75.87.48:14600/profile/";
...
//       "race": race,
//       "typename": type,
//       "image": new http.MultipartFile('image', stream, length),
...
Future<User> deleteanimal(String id, String animal) async {
  final http.Response response = await http.delete(
    Uri.parse(VPNURL + 'user/removeanimal'),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=UTF-8'
    },
    body: jsonEncode(<dynamic, dynamic>{

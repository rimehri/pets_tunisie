                             ...
                             children: [
                               Row(
                                 children: [
                                   IconButton(
                                     icon:
                                     SvgPicture.asset("assets/money-bag.svg",color: Colors.blue,
                                       width: 20.0,
                               ...
                               Row(
                                 children: [
                                   IconButton(
                                     icon:
                                     SvgPicture.asset("assets/cheque.svg",color: Colors.blue,
                                       width: 20.0,
                          ...
                          children: [
                            ...
                            Column(children: [
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    Container(child: Text("1er Seance "),) ,
                                    SizedBox(width: 60,),
                                    Container(child: Text("1er Seance "),)
                                  ],
                                ),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Container(child: Text("Dim "),),
                                        Container(margin: EdgeInsets.only(left: 50,), child: Text(" Cabinet Fermé  ",style: TextStyle(color: Colors.red),),),
...
Widget myflexible(){
  ...
  Container(
  child: Text("Dr Fedia Mtaala",style: TextStyle(color: Colors.blue,fontSize: 20),)
  ),
  Container(child: Text("vétérinaire",style: TextStyle(fontSize: 15,color: Colors.black45),),),
  Padding(

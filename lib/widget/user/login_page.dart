                              ...
                              Container(
                                child: TextFormField(
                                  ...
                                  decoration: ThemeHelper().textInputDecoration(
                                      'phone', 'Entrez Ton phone'),
                                  validator: (val) {
                                    if ((val!.isEmpty)) {
                                      return "entrez votre phone valide";
                                    }
                                    return null;
                                  },
                                ),
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    if (_formKey.currentState!.validate()) {
                                      ...
                                      Autogenerated u = await login(email, password);
                                      final prefs = await SharedPreferences.getInstance();
                                      prefs.setString("token", u.token!);
                                      prefs.setString('id', u.user!.sId!);

                                      await prefs.setString('addresse', u.user!.addresse!);
                                      await prefs.setString('mail', u.user!.email!);
                                      await prefs.setString('name', u.user!.name!);
                                     await prefs.setString('phone', u.user!.phone!);
                                      setState(() {
                                        //currentuser = u.sId!;
                                      });
                                      print(password);
